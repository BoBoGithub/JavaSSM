...
<section class="panel panel-default">
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" placeholder="请输入产品名称" value="${productData.productName}" name="productName" id="productName">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" placeholder="请输入借款额度" value="${productData.borrowMoney}" name="borrowMoney" id="borrowMoney">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" placeholder="请输入借款期限" value="${productData.borrowLimit}" name="borrowLimit" id="borrowLimit">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" placeholder="请输入日利率" value="${productData.dayRate}" name="dayRate" id="dayRate">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" placeholder="请输入服务费" value="${productData.serviceCharge}" name="serviceCharge" id="serviceCharge">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<label class="radio-inline">
						<input type="radio" name="productStatus" value="1"  <c:if test="${productData.status == 1}">checked</c:if>> 启用
					</label>
					<label class="radio-inline">
						<input type="radio" name="productStatus" value="0" <c:if test="${productData.status == 0}">checked</c:if>> 停用
					</label>
				</div>
								
			</div>
			<footer class="panel-footer text-right bg-light lter">
				<button type="button" class="btn btn-success btn-s-xs" id="submit">修改</button>
		...
		<script>
			...
			$('#submit').click(function(){
				...
				$.ajax({
	              type: 'post',
	              url: '${basePath}/admin/product/do/edit',
