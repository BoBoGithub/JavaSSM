...
<section class="panel panel-default">
			<div class="panel-body">
					...
					<div class="col-sm-9">
						<div class="dropdown">  
								<button class="btn btn-default" data-toggle="dropdown" id="dropdownBtn">  
									<span id="menText">${adminMenuP.name}</span>  
									<span class="caret"></span>  
								</button>  
								<input type="hidden" value="${adminMenuP.id}" id="parentId" />
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" placeholder="请输入菜单名称" name="menuName" id="menuName" value="${adminMenu.name}">
					</div>
				</div>
				<div class="line line-dashed line-lg pull-in"></div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" placeholder="请输入请求地址" name="requestUrl" id="requestUrl" value="${adminMenu.url}">
					</div>
				</div>
				<div class="line line-dashed line-lg pull-in"></div>
 				<div class="form-group">
					...
					<label class="radio-inline">
						<input type="radio" name="menuStatus" value="0" <c:if test="${adminMenu.status == 0}">checked</c:if>> 是
					</label>
					<label class="radio-inline">
						<input type="radio" name="menuStatus"  value="1" <c:if test="${adminMenu.status == 1}">checked</c:if>> 否
					</label>
				</div>
			</div>
		...
		<script>
			...
			$('#submit').click(function(){
				...
				$.ajax({
					  type: 'post',
		              url: '${basePath}/admin/setup/edit/menu',
		              dataType: 'json',
