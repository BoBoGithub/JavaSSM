...
<section class="panel panel-default">
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="dropdown">  
								<c:choose>
									<c:when test="${adminUserRole.roleName != null}">
										<button class="btn btn-default" data-toggle="dropdown" id="dropdownBtn">  
											<span id="roleText">${adminUserRole.roleName}</span>  
											<span class="caret"></span>  
										</button>  
										<input type="hidden" value="${adminUserRole.roleId}" id="roleId" />
									</c:when>
									<c:otherwise>
										<button class="btn btn-default" data-toggle="dropdown" id="dropdownBtn">  
								...
								<ul class="dropdown-menu" style="max-height: 285px; overflow-y: auto;cursor:pointer;" id="roleSelect">  
									<li data-original-index="0" <c:if test="${adminUserRole.roleName == null}">class="selected active"</c:if>><a>选择角色</a></li>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" placeholder="请输入用户名" name="username" id="username" value="${adminUserInfo.username}">
					</div>
				</div>
				<div class="line line-dashed line-lg pull-in"></div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" placeholder="请输入真实新姓名" name="realname" id="realname" value="${adminUserInfo.realname}">
					</div>
				</div>
				<div class="line line-dashed line-lg pull-in"></div>
				<div class="form-group">
	    ...
	    $('.dropdown-menu li').click(function(){
			...
			$('#submit').click(function(){
				...
				$.ajax({
	              type: 'post',
	              url: '${basePath}/admin/setup/user/post/edit',
	              contentType:'application/json;charset=UTF-8',
	              dataType: 'json',
	              cache:false,
	              timeout: 60000, 
	              data:JSON.stringify({
	            	  adminUid: ${adminUserInfo.uid},
	            	  roleId:	roleId,
	            	  userName: username, 
	            	  realName: realname,
	            	  password: password
